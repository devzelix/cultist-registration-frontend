    ...
    <>
      ...
      <footer className="p-10 flex flex-col items-center justify-center gap-y-8 bg-tertiary shadow-[-5px_-5px_10px_rgba(0,0,0,0.3)]">
        <div className="flex items-center justify-center gap-x-6">
          ...
          >
            <img src={facebook} alt="logo de instagram" className="size-7" />
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <img src={instagram} alt="logo de instagram" className="size-7" />
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <img src={web} alt="logo de instagram" className="size-7" />
          </a>
        </div>
        <small className="font-inter font-medium text-text text-[0.65rem]">
